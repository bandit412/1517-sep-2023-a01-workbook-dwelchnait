...
internal partial class WestWindContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BuildVer__3214EC078090A14B");
        ...
        {
            entity.HasKey(e => e.ManifestItemID).HasName("PK__Manifest__9000192CE6C9A0A8");
        ...
        {
            entity.HasKey(e => e.ShipmentID).HasName("PK__Shipment__5CAD378DDCDE16A9");
